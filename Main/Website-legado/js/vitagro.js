...
function token(){
    ...
    if(text == ""){
        ...
        invalid_token.innerHTML = "<img src='img/denied.png'> <span class='denied'> Token Inválido! </span>";
        return false;
    } else{
        input_token.style.border = "2px solid green";
        invalid_token.innerHTML = "<img src='img/accept.png'> <span class='accept'> Token Ok! </span>";
        return true;
    }
}
function cpf(){
    ...
    if (cpfLength < 11 || cpfLength > 11){
        ...
        invalid_cpf.innerHTML = "<img src='img/denied.png'> <span class='denied'> O CPF deve ter 11 dígitos!</span>";
        return false;
    } else{
        text = cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, "$1.$2.$3-$4");
        input_cpf.value = text;
        input_cpf.style.border = "2px solid green";
        invalid_cpf.innerHTML = "<img src='img/accept.png'> <span class='accept'> CPF Ok! </span>";
        return true;
    }
