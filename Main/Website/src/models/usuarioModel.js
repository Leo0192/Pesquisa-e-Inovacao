...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idRepresentante, nome_representante, fkEmpresa as empresaId FROM representante 
        inner join contato_representante on fkRepresentante=idRepresentante WHERE email_representante = '${email}' AND senha = '${senha}';
    `;
