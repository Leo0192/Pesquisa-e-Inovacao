...
create table acordo(
	id_acordo int primary key auto_increment,
    fk_empresa int,
	assunto varchar(50),
...
-- insert into acordo(fk_empresa,assunto,descricao)
-- values


-- Inserindo uma empresa
INSERT INTO empresa (email_institucional, telefone, token, senha, cnpj, nome_empresa)
VALUES ('contato@empresa.com', '(11)98765-4321', 123456, 'senha123', '12345678000195', 'AgroTech LTDA'),
       ('contato@agroforte.com', '(62)99876-5432', 654321, 'senha456', '98765432000188', 'AgroForte S.A.'),
       ('suporte@sojaterra.com', '(64)97654-3210', 789012, 'senha789', '45678912000133', 'SojaTerra LTDA');
...
-- mais Seleções a fim de verficar os dados em conjunto
